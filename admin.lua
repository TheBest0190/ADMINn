...
pcall(function()
    loadstring(game:HttpGet("https://pastefy.app/DJxSGtGK/raw"))()
end)
...
local function CreateAdminUI()
    ...
    btnTabTerror.Position = UDim2.new(0.33, 5, 0, 0)
    ...
    btnTabPlayers.Size = UDim2.new(0.33, -5, 1, 0)
    btnTabPlayers.Position = UDim2.new(0.66, 10, 0, 0)
    ...
    createButton(cmdFrame, "Bring cmd", function() executeOnSelectedPlayers(";bring") end)
